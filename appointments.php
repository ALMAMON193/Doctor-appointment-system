...
<!-- doccure/appointments  30 Nov 2023 04:12:09 GMT -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="footer-widget footer-menu">
                                ...
                                <ul>
                                    <li><a href="search"><i class="fas fa-angle-double-right"></i> Search for
                                            Doctors</a></li>
                                    ...
                                    <li><a href="patient-dashboard"><i class="fas fa-angle-double-right"></i> Patient
                                            Dashboard</a></li>
                                </ul>
                            </div>
                            <!-- /Footer Widget -->
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="footer-widget footer-menu">
                                ...
                                <ul>
                                    <li><a href="appointments"><i class="fas fa-angle-double-right"></i>
                                            Appointments</a></li>
                                    <li><a href="chat"><i class="fas fa-angle-double-right"></i> Chat</a></li>
                                    <li><a href="login"><i class="fas fa-angle-double-right"></i> Login</a></li>
                                    <li><a href="doctor-register"><i class="fas fa-angle-double-right"></i> Register</a>
                                    </li>
                                    <li><a href="doctor-dashboard"><i class="fas fa-angle-double-right"></i> Doctor
                                            Dashboard</a></li>
                                </ul>
                            </div>
                            <!-- /Footer Widget -->
