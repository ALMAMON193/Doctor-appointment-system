...
if (isset($_POST['submit'])) {
	...
	if (!empty($users_first_name) && !empty($users_last_name) && !empty($users_email) && !empty($users_password) && !empty($passwordagain)) {
		if ($users_password !== $passwordagain) {
			...
			$pasmatchmsg = '';
			$sql = "INSERT INTO patients(users_first_name, users_last_name, users_email, users_password) 
...
<!-- doccure/register  30 Nov 2023 04:12:20 GMT -->
							...
							<div class="row align-items-center justify-content-center">
								...
								<div class="col-md-12 col-lg-6 login-right">
									<div class="login-header">
										<h3>Patient Register <a href="doctor-register">Are you a patient?</a></h3>
									</div>
									...
									<form action="register" method="POST">
										...
										<div class="text-right">
											<a class="forgot-link" href="patient-login">Already have an account?</a>
										</div>
