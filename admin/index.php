							...
							<div class="card-body">
								<div class="dash-widget-header">
									...
									<div class="dash-count">
										...
										$number_doctors = mysqli_num_rows($doctors);

										?>
										<h3>
											<?php echo $number_doctors; ?>
										</h3>
									</div>
								</div>
							...
							<div class="card-body">
								<div class="dash-widget-header">
									...
									<?php
										...
										$number_patient = mysqli_num_rows($patient);

										?>
										<h3>
											<?php echo $number_patient; ?>
										</h3>
									</div>
								</div>
								<div class="dash-widget-info">
											...
											<tr>
												<td>
													<h2 class="table-avatar">
														<a href="profile" class="avatar avatar-sm mr-2"><img
																class="avatar-img rounded-circle"
																src="assets/img/doctors/doctor-thumb-01.jpg"
																alt="User Image"></a>
