...
if (isset($_POST['submit'])) {
	...
	if (!empty($users_email) && !empty($users_password)) {
		$sql = "SELECT * FROM doctors WHERE users_email='$users_email' AND users_password = '$passwordmd5'";
		...
		if ($query->num_rows > 0) {
			...
			header('location:http://heltcare.org/doctor-dashboard');
		} else {
						...
						<div class="account-content">
							<div class="row align-items-center justify-content-center">
								...
								<div class="col-md-12 col-lg-6 login-right">
									...
									<h3>Doctor Login <a href="patient-login">Are You doctor?</a></h3>
									</div>
